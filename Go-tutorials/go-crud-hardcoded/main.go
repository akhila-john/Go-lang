...
import (
	...
	//json/encoding package contains methods that can be used to convert a
	//request body of an incoming HTTP request into a golang struct
	"encoding/json"
	"fmt"
	"log"
	"net/http"
...
var movies = []Movie{
	{ID: "1", Isbn: "456783", Title: "Movie one"},
	{ID: "2", Isbn: "456678", Title: "Movie two"},
}
...
func createMovie(w http.ResponseWriter, r *http.Request) {
	...
	// incoming json converted back to struct --decode
	...
	//returns the created movie within the post request of postman
