...
func main() {
	...
	router.HandleFunc("/getstudent", getStudent).Methods("GET")
	router.HandleFunc("/getstudent", createstudent).Methods("POST")
	router.HandleFunc("/getstudent/{id}", getStudentById).Methods("GET")
	router.HandleFunc("/getstudent/{id}", deleteStudent).Methods("DELETE")
